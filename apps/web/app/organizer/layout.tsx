...
import { LayoutDashboard, Calendar, BarChart3, FileText, Ticket, X, Menu } from 'lucide-react'
...
export default function OrganizerLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-[80vh]">
      <aside className="hidden lg:flex lg:flex-col w-64 border-r border-gray-200 bg-white shrink-0">
        <div className="p-4 border-b border-gray-200">
          <Link href="/organizer" className="flex items-center gap-2 font-bold text-lg text-indigo-600">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="lg:hidden border-b border-gray-200 bg-white px-4 py-3 flex items-center justify-between">
          ...
          <Link href="/organizer" className="font-bold text-indigo-600">Quản lý sự kiện</Link>
          <div />
        </header>
          ...
          <>
            ...
            <aside className="fixed inset-y-0 left-0 z-50 w-64 bg-white border-r border-gray-200 lg:hidden">
              <div className="flex items-center justify-between p-4 border-b">
                <span className="font-bold text-indigo-600">Quản lý sự kiện</span>

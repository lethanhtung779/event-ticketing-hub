          ...
          <table className="w-full text-sm">
            <thead className="bg-gray-50 dark:bg-gray-800/50 text-left">
              <tr>
                ...
                <th className="px-4 py-3 font-medium text-gray-500 dark:text-gray-400">Đối tượng</th>
                <th className="px-4 py-3 font-medium text-gray-500 dark:text-gray-400">Chi tiết</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
              {logs.length === 0 ? (
                <tr><td colSpan={5} className="px-4 py-12 text-center text-gray-500 dark:text-gray-400">Chưa có nhật ký</td></tr>
              ) : logs.map((log) => (
